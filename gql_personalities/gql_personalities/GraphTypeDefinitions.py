...
@strawberryA.federation.type(keys=["id"], description="""Entity representing a rankType""")
...
@strawberryA.federation.type(keys=["id"], description="""Entity representing a certificate""")
...
@strawberryA.federation.type(keys=["id"], description="""Entity representing a certificateType""")
...
@strawberryA.federation.type(keys=["id"], description="""Entity representing a certificateTypeGroup""")
...
@strawberryA.federation.type(keys=["id"], description="""Entity representing a medalType""")
...
@strawberryA.federation.type(keys=["id"], description="""Entity representing a medalTypeGroup""")
...
@strawberryA.federation.type(keys=["id"], description="""Entity representing a workHistory""")
...
@strawberryA.federation.type(keys=["id"], description="""Entity representing a relatedDoc""")
