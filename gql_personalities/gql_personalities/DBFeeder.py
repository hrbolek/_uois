...
def determineStudyPlace():
    studyPlaces = [
        ...
        {'name': 'Vysoká škola báňská v Ostravě (VŠB)',                                 'id': 'c63b55eb-c6a0-4302-aa27-3ff8f082cc35' },
...
async def ensureAllTypes(asyncSessionMaker):
        ...
        putPredefinedStructuresIntoTable(asyncSessionMaker, RankTypeModel, determineRankType),
        putPredefinedStructuresIntoTable(asyncSessionMaker, StudyTypeModel, determineStudyPlace),
        putPredefinedStructuresIntoTable(asyncSessionMaker, StudyTypeModel, determineStudyProgram),
        putPredefinedStructuresIntoTable(asyncSessionMaker, CertificateTypeModel, determineCertificateType),
        putPredefinedStructuresIntoTable(asyncSessionMaker, CertificateTypeGroupModel, determineCertificateTypeGroup),
        putPredefinedStructuresIntoTable(asyncSessionMaker, MedalTypeModel, determineMedalType),
        putPredefinedStructuresIntoTable(asyncSessionMaker, MedalTypeGroupModel, determineMedalTypeGroup),
        putPredefinedStructuresIntoTable(asyncSessionMaker, WorkHistoryModel, determineWorkHistoryPosition),
    )
    return
