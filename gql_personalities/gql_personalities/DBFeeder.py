...
def determineRankType():
    rankTypes = [
        #mužstvo
        {'name': 'vojín (voj.)','name_en': 'Private (PVT)', 'id': 'de5e6ae8-902c-4b06-aa8e-8fbca99026f3' },
        {'name': 'svobodník (svob.)','name_en': 'Private First Class (PFC)', 'id': 'f3038058-e1fa-4f7c-9e50-7b1d99998d37' },

        #poddůstojníci
        {'name': 'desátník (des.)','name_en': 'Corporal (CPL)', 'id': 'a3cdae76-1c7d-409c-8bed-9e922c066bce' },
        {'name': 'četař (čet.)','name_en': 'Sergeant (SGT)', 'id': 'a17e81a6-776b-4883-a04d-cbd4f07ad095' },
        {'name': 'rotný (rtn.)','name_en': 'Staff Sergeant (SSG)', 'id': 'a9043224-9c3b-4562-a329-997fba9237d0' },

        #praporčíci
        {'name': 'rotmistr (rtm.)','name_en': 'Sergeant First Class (SFC)', 'id': '72294ac5-1823-4164-9805-60a0aaa39296' },
        {'name': 'nadrotmistr (nrtm.)','name_en': 'Master Sergeant (MSG)', 'id': '453dff9e-fab2-41d0-8bef-ca76c78e79c8' },
        {'name': 'praporčík (prap.)','name_en': 'Chief Warrant Officer (CW2)', 'id': '6a324f4a-2162-4fe7-a47c-8be1f3c9452b' },
        {'name': 'nadpraporčík (nprap.)','name_en': 'Chief Warrant Officer (CW3)', 'id': '34cfd57e-6a09-4423-8025-b44d6dbce774' },
        {'name': 'štábní praporčík (št. prap.)','name_en': 'Master Warrant Officer (MW4)', 'id': '841fa09f-625e-49b4-8872-05c43ce197cf' },

        #nižší důstojníci
        {'name': 'poručík (por.)','name_en': 'Lieutenant (LT)', 'id': '3914ab9f-78bc-45ac-bb2d-59ee921f3a19' },
        {'name': 'nadporučík (npor.)','name_en': 'First Lieutenant (1LT)', 'id': '437fa94e-8442-4667-af9a-8327afef9ffa' },
        {'name': 'kapitán (ktp.)','name_en': 'Captain (CPT)', 'id': 'a8ce2853-26ec-4e10-8bbe-899cc296a35f' },

        #vyšší důstojníci
        {'name': 'major (mjr.)','name_en': 'Major (MAJ)', 'id': '587cd381-aeec-4367-91f3-8849f900848a' },
        {'name': 'podplukovník (pplk.)','name_en': 'Lieutenant Colonel (LTC)', 'id': '46a7325f-9b9e-4e80-9f17-670bd9151229' },
        {'name': 'plukovník (plk.)','name_en': 'Colonel (COL)', 'id': '824533e5-eba7-45f7-80f6-e2466529e73c' },

        #generálové
        {'name': 'brigádní generál (brig.gen.)','name_en': 'Brigadier General (BG)', 'id': '9eb8d8f4-a87c-447d-aaee-c0a15cd6fbce' },
        {'name': 'generálmajor (genmjr.)','name_en': 'Major General (MG)', 'id': 'd65a0d25-dc39-46fa-a107-a684c9724c5e' },
        {'name': 'generálporučík (genpor.)','name_en': 'Lieutenant General (LTG)', 'id': '41f0772d-738a-492d-93c1-96c9cdb5d597' },
        {'name': 'armádní generál (arm.gen.)','name_en': 'General of the Army (GA)', 'id': '9234d06c-e811-4016-8ee5-f6975b4048a4' },
    ]
    return rankTypes
...
def determineStudyProgram():
    studyPrograms = [
        {'name': 'bakalářský','name_en': 'bachelor', 'id': '00602448-9d42-4af3-95fd-20fd6a551771' },
        {'name': 'magisterský','name_en': 'master', 'id': 'f0e17944-e7d8-434a-9b36-b70cf6f0fac5' },
        {'name': 'doktorský','name_en': 'doctoral', 'id': '0ea55a54-1fa5-43ce-b2e6-67ebf57c9671' },
    ]
...
def determineCertificateTypeGroup():
    certificateTypeGroups = [
        {'name': 'jazykové', 'name_en': 'language', 'id': 'db9ba8c3-3d6e-4190-bfe7-d401586dd282'},
        {'name': 'vědecké', 'name_en': 'science', 'id': 'bc988cb6-38a7-45a1-97ec-d1e220621355'},
        {'name': 'sportovní', 'name_en': 'sport', 'id': '3f1351ca-0624-43bb-9c93-23e6478fb1c1'},
        {'name': 'pracovní', 'name_en': 'work', 'id': 'e4713dd6-69e6-4d35-964b-1bca141899eb'},
    ]
