...
from gql_personalities.DBDefinitions import Personalities_CertificateType, Personalities_MedalType, Personalities_MedalTypeGroup

import asyncio
async def ensureAllTypes(asyncSessionMaker):
    done = await asyncio.gather(
        putPredefinedStructuresIntoTable(asyncSessionMaker, Personalities_CertificateType, determineCertificateTypes),
        putPredefinedStructuresIntoTable(asyncSessionMaker, Personalities_MedalType, determineMedalTypes),
        putPredefinedStructuresIntoTable(asyncSessionMaker, Personalities_MedalTypeGroup, determineMedalTypeGroup)
    )
    return 
