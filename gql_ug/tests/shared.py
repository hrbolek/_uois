...
def get_demodata():
    ...
    result = {
        ...
        'users': [
            {'id': '2d9dc5ca-a4a2-11ed-b9df-0242ac120003', 'name': 'John', 'surname': 'Newbie', 'email': 'john.newbie@world.com'},
            {'id': '2d9dc868-a4a2-11ed-b9df-0242ac120003', 'name': 'Julia', 'surname': 'Newbie', 'email': 'julia.newbie@world.com'},
            {'id': '2d9dc9a8-a4a2-11ed-b9df-0242ac120003', 'name': 'Johnson', 'surname': 'Newbie', 'email': 'johnson.newbie@world.com'},
            {'id': '2d9dcbec-a4a2-11ed-b9df-0242ac120003', 'name': 'Jepeto', 'surname': 'Newbie', 'email': 'jepeto.newbie@world.com'},
        ],
        'groups': [
            {'id': '2d9dcd22-a4a2-11ed-b9df-0242ac120003', 'name': 'Uni', 'grouptype_id': 'cd49e152-610c-11ed-9f29-001a7dda7110', 'mastergroup_id': None}, 
            {'id': '2d9dced0-a4a2-11ed-b9df-0242ac120003', 'name': 'Fac', 'grouptype_id': 'cd49e153-610c-11ed-bf19-001a7dda7110', 'mastergroup_id': '2d9dcd22-a4a2-11ed-b9df-0242ac120003'},
            {'id': '2d9dd1c8-a4a2-11ed-b9df-0242ac120003', 'name': 'Dep', 'grouptype_id': 'cd49e155-610c-11ed-844e-001a7dda7110', 'mastergroup_id': '2d9dced0-a4a2-11ed-b9df-0242ac120003'},
            {'id': '2d9dd2ea-a4a2-11ed-b9df-0242ac120003', 'name': 'St', 'grouptype_id': 'cd49e157-610c-11ed-9312-001a7dda7110', 'mastergroup_id': '2d9dced0-a4a2-11ed-b9df-0242ac120003'},
        ],
        'memberships': [
            {'id': '7cea8596-a4a2-11ed-b9df-0242ac120003', 'user_id': '2d9dc5ca-a4a2-11ed-b9df-0242ac120003', 'group_id': '2d9dcd22-a4a2-11ed-b9df-0242ac120003'}
        ],
        'roles': [
            {'id': '7cea8802-a4a2-11ed-b9df-0242ac120003', 'user_id': '2d9dc5ca-a4a2-11ed-b9df-0242ac120003', 'group_id': '2d9dcd22-a4a2-11ed-b9df-0242ac120003', 'roletype_id': 'ae3f0d74-6159-11ed-b753-0242ac120003'}
        ],
    }
    return result
...
async def prepare_demodata(async_session_maker):
    ...
    await ImportModels(async_session_maker, [UserModel, GroupModel, GroupTypeModel, MembershipModel, RoleModel, RoleTypeModel], data)
