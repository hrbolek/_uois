...
import { UsersByLettersQuery } from "@uoisfrontend/shared/src/Queries/UsersByLettersQuery";
import { GroupsByLettersQuery } from "@uoisfrontend/shared/src/Queries/GroupsByLettersQuery";
import { AllByLettersQuery } from "@uoisfrontend/shared/src/Queries/AllByLettersQuery";
...
const UserSuggestion = ({user, UserComponent=UserLink}) => {
    return (
        <li><UserComponent user={user} /></li>
    )
}

const GroupSuggestion = ({group, GroupComponent=GroupLink}) => {
    return (
...
export const SearchSmall = ({users, groups, UserComponent, GroupComponent}) => {
