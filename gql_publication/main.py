...
from gql_publication.GraphTypeDefinitions import Query
...
async def RunOnceAndReturnSessionMaker():
    ...
    #     createDataStructurePublicationType(result,parsedDataset['publication_types']),
    #     createDataStructurePublication(result,parsedDataset['publications']),
    #     createDataStructureAuthor(result,parsedDataset['authors'])
    # )
    print(f'all done')
    return result
